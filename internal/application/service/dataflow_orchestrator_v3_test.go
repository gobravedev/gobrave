...
// func (r *inMemoryAnalysisRepo) PageAnalysisNodesByProjectID(_ context.Context, pagination *types.Pagination, projectID int64, scriptID string) ([]*types.AnalysisNode, int64, error) {
// 	r.mu.Lock()
// 	defer r.mu.Unlock()
...
// 			continue
// 		}
// 		if scriptID != "" && node.ScriptID != scriptID {
// 			continue
// 		}
// 		cloned := *node
